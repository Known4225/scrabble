...
void ribbonDraw() {
    ...
    turtleQuadAlpha(ribbonRender.bounds[0], ribbonRender.bounds[3] - 10, ribbonRender.bounds[2], ribbonRender.bounds[3] - 10, ribbonRender.bounds[2], ribbonRender.bounds[3], ribbonRender.bounds[0], ribbonRender.bounds[3], ribbonRender.colors[0], ribbonRender.colors[1], ribbonRender.colors[2], 50.0); // render ribbon
    ...
    for (int i = 0; i < ribbonRender.options -> length; i++) {
        ...
        if (i == ribbonRender.mainselect[2]) {
            ...
            turtleQuad(xLeft, ribbonRender.bounds[3] - 10, xRight, ribbonRender.bounds[3] - 10, xRight, yDown, xLeft, yDown, ribbonRender.colors[3], ribbonRender.colors[4], ribbonRender.colors[5]); // ribbon highlight
            for (int j = 1; j < ribbonRender.options -> data[i].r -> length; j++) {
        ...
        if (turtle.mouseY > ribbonRender.bounds[3] - 10 && turtle.mouseY < ribbonRender.bounds[3] && turtle.mouseX > ribbonRender.bounds[0] + ribbonRender.marginSize / 2.0 && turtle.mouseX < cutoff - ribbonRender.marginSize / 2.0 && ribbonRender.mainselect[0] == -1) { // -217, -195, -164
            turtleQuad(prevCutoff - ribbonRender.marginSize / 2.0, 179, cutoff - ribbonRender.marginSize / 2.0, 179, cutoff - ribbonRender.marginSize / 2.0, 171, prevCutoff - ribbonRender.marginSize / 2.0, 171, ribbonRender.colors[3], ribbonRender.colors[4], ribbonRender.colors[5]); // render dropdown
