...
/* top level boolean output call to check if the key with code [key] is currently being held down */
...
/* set the pen shape ("circle", "square", "triangle", "none", "connected", "text")*/
...
/* blits a triangle directly to the screen with transparency */
void turtleTriangle(double x1, double y1, double x2, double y2, double x3, double y3, double r, double g, double b) { // adds a (blit) triangle to the pipeline (for better speed)
    ...
    list_append(turtle.penPos, (unitype) 0.0, 'd');
...
/* blits a triangle directly to the screen with transparency */
void turtleTriangleAlpha(double x1, double y1, double x2, double y2, double x3, double y3, double r, double g, double b, double a) {
    list_append(turtle.penPos, (unitype) x1, 'd');
    list_append(turtle.penPos, (unitype) y1, 'd');
    list_append(turtle.penPos, (unitype) x2, 'd');
    list_append(turtle.penPos, (unitype) (r / 255), 'd');
...
/* blits a quad directly to the screen */
void turtleQuad(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4, double r, double g, double b) { // adds a (blit) quad to the pipeline (for better speed)
    list_append(turtle.penPos, (unitype) x1, 'd');
    list_append(turtle.penPos, (unitype) y1, 'd');
    list_append(turtle.penPos, (unitype) x2, 'd');
    list_append(turtle.penPos, (unitype) (r / 255), 'd');
...
/* blits a quad directly to the screen with transparency */
void turtleQuadAlpha(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4, double r, double g, double b, double a) { // adds a (blit) quad to the pipeline (for better speed)
    list_append(turtle.penPos, (unitype) x1, 'd');
    list_append(turtle.penPos, (unitype) y1, 'd');
    list_append(turtle.penPos, (unitype) x2, 'd');
    list_append(turtle.penPos, (unitype) (r / 255), 'd');
